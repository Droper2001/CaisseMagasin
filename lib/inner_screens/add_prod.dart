  ...
  void _uploadForm() async {
    ...
    if (isValid) {
      ...
      try {
        ...
        // kIsWeb ? webImage : _
      //   Reference ref = fb.storage().ref().child('${DateTime.now()}.png');
      // UploadTask uploadTask = ref.putData(webImage, SettableMetadata(contentType: 'image/png'));
...
// String url = await taskSnapshot.ref.getDownloadURL();
        ...
        fb.StorageReference storageRef =
            fb.storage().ref().child('productsImages').child(_uuid);
                  // UploadTask uploadTask = ref.putData(webImage, SettableMetadata(contentType: 'image/png'));

        final fb.UploadTaskSnapshot uploadTaskSnapshot =await storageRef.put(webImage).future;
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return 'veuillez entrez un Nom pour le produit ';
                                }
                                return null;
                              },
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: TextFormField(
                                            ...
                                            key: const ValueKey('Prix en  \$'),
                                            keyboardType: TextInputType.number,
                                            validator: (value) {
                                              if (value!.isEmpty) {
                                                return 'le prix est raté';
                                              }
                                              return null;
                                            },
                                            inputFormatters: <
